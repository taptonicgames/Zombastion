...
public abstract class AbstractSavingManager
{
	...
	protected Dictionary<SavingDataType, AbstractSavingData> savingDataPairs = new Dictionary<SavingDataType, AbstractSavingData>();
	...
	public bool DontSave { get => dontSave; }
